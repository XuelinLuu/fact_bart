...
class StanfordOpenIE:
    ...
    def annotate(self, text: str, properties_key: str = None, properties: dict = None, simple_format: bool = True):
        ...
        # return core_nlp_output['sentences']
        if simple_format:
            # triples = []
            for sentence in core_nlp_output['sentences']:
                return sentence['openie']
...
if __name__ == '__main__':
    ie = StanfordOpenIE()
    text = "It's official"
    # text = "It's official: U.S. President Barack Obama wants lawmakers to weigh in on whether to use military force in Syria."
    # text = 'luxuelin is from China'
    print(ie.annotate(text, simple_format=False))